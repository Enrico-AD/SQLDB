...
DROP TABLE t_sip_execucao_proj CASCADE CONSTRAINTS;
...
drop sequence sq_sip_bairro;
drop sequence sq_sip_cidade;
drop sequence sq_sip_dependente;
drop sequence sq_sip_depto;
drop sequence sq_sip_endereco;
drop sequence sq_sip_estado;
drop sequence sq_sip_execucao_proj;
drop sequence sq_sip_funcionario;
drop sequence sq_sip_funcionario_endereco;
drop sequence sq_sip_projeto;
drop sequence sq_sip_tipo_endereco;
